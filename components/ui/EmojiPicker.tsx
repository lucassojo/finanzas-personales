...
const EMOJI_CATEGORIES = [
  ...
  },
  {
    ...
    emojis: [
      ...
      '🎻', '🎲', '♟️', '🎯', '🎳', '🎮', '🎰', '🧩', ' skating', ' skiing', 
      ' snowboarding', ' surfing', ' swimming', ' cycling', ' running', ' yoga'
    ]
  },
  {
    name: 'Viajes',
    ...
    emojis: [
      '🚗', '🚕', '🚙', '🚌', '🚎', '🏎️', '🚓', '🚑', '🚒', '🚐', 
      '🚚', '🚛', ' tractor', '🛵', '🚲', '🛴', ' train', ' metro', ' subway', ' airplane', 
      ' flight', ' helicopter', '🚀', '🛸', ' boat', ' ship', ' anchor', ' ring', ' gas', 
      ' map', '🗽', '🗼', '🏰', ' stadium', ' mountain', ' camping', ' tent', '🏠', '🏢', 
      ' hospital', ' bank', ' hotel', ' school', ' factory', ' church', ' mosque'
    ]
  },
  {
    name: 'Objetos',
    ...
    emojis: [
      ...
      '🖋️', '🖊️', '📝', '📁', '📂', '📅', '📆', '🗒️', '📖', '📚', 
      '🔒', '🔓', '🔑', '🔨', '🛠️', '🧰', '⚙️', '🛡️', '⚔️', '🔬', 
      '🔭', '🩺', ' syringe', ' bandage', ' mirror', ' chair', ' window', ' bed', ' door'
    ]
  },
  {
    name: 'Símbolos',
